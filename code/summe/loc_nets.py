...
class MultiHeadAttention(nn.Module):
    ...
    def forward(self, x):
        ...
        y = y.reshape(batch_size, self.num_head, seq_len, self.d_k).permute(0, 2, 1, 3).contiguous().view(batch_size, seq_len, num_feature)
...
class ScaledDotProductAttention(nn.Module):
    ...
    def forward(self, Q, K, V):
        ...
        y = (attn @ V).transpose(1, 2) #.reshape(B, N_head, N, d)
